...
{
    public partial class OutletListViewController : UIViewController
    {
        public OutletListViewController (IntPtr handle) : base (handle)
        {
        }
        ...
        public override void ViewWillAppear(bool animated)
        {
            ...
            this.NavigationController.NavigationBar.BarTintColor = Constants.PALETTE_GREEN_PRIMARY;
            this.NavigationController.NavigationBar.BackgroundColor = Constants.PALETTE_GREEN_PRIMARY;
