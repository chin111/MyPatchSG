...
{
    class OutletItemSalesTableHolder : RecyclerView.ViewHolder
    {
        public TableLayout SalesTable { get; set; }
        private ViewGroup parentView;
        public OutletItemSalesTableHolder(View itemView, ViewGroup parent) : base(itemView)
        {
            this.parentView = parent;

            SalesTable = itemView.FindViewById<TableLayout>(Resource.Id.item_vwsaleste_table);

            SalesTable.SetOnClickListener(null);
            SalesTable.Clickable = false;
        }
        ...
        private void AddEmptyRow()
        {
            ...
            SalesTable.AddView(rowItem);
        }
        private void AddRow(vwSalesOutlet item)
        {
            View view = LayoutInflater.From(this.parentView.Context).Inflate(Resource.Layout.item_vwsaleste_item, this.parentView, false);
            TableRow rowItem = (TableRow)view;
